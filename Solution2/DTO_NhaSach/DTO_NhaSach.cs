   ...
   public class DTO_NhaSach1
    {
        ...
        public DTO_NhaSach1(string MaSach, string TenSach, string TacGia, DateTime NgayXuatBan, string KichThuoc, string SoTrang, string NXB, string Gia, string TongSoLuong, DateTime NgayNhapKho)
        {
            this.MaSach = MaSach;
